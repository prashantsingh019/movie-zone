...
const displayMovies = (movie) => {
  root.innerHTML = movie
    ...
    <div class="movie-card">
            <div class="image-container onHoverEffect">
...
const root = document.querySelector(".dom-container");
...
buttons.forEach((button) => {
  button.addEventListener("click", (e) => {
    ...
    const filtered = movies.filter((movie) => {
      return movie.category.toLowerCase() == e.target.innerText.toLowerCase();
    });
